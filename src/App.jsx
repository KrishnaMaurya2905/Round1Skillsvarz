  ...
  return (
    ...
    >
      ...
      <div className="fixed top-0 left-0 z-2 h-[10vh] w-full px-10 max-md:px-3 flex items-center justify-between text-white">
        <h5 className="font-['Decorative'] text-4xl">R.</h5>
        <div className="flex gap-2">
          <div className="flex gap-1 font-['Secondary']">
            ...
            <Button className="bg-white/10 border-white/15 rounded-sm text-white p-3 max-md:text-sm text-lg leading-none">
              <h2>Explore Premium</h2>
            </Button>
          </div>
        </div>
      </div>
